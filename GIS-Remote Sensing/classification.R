...
setwd("E:/2021/remote sensing/defor")

#set shapefile
shapefile <- "E:/2021/remote sensing/defor/training.shp"

#Number of classes
classNums <- c(21,13,31,11)
...
outImageName<-'2016_2021_RandomForest.tif'
